...
-- stores metadata and results, not full table data for compression testing.
--   - Initial size: 512M (vs 1G on target)
--   - Max size: 5G (vs 10G on target)
--   - Second datafile: 256M (vs 512M on target)
-- ============================================================================
...
PROMPT (Central DB - Reduced Size)
PROMPT ========================================
...
-- Create SCRATCH tablespace for central metadata storage
-- This tablespace stores analysis results, strategy definitions, and session data
