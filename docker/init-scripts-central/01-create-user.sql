...
-- Description: Create dedicated user for HCC Compression Advisor Central DB
...
PROMPT (Central Metadata Server)
PROMPT ========================================
...
-- Create dedicated user for compression advisor central database
-- This user manages metadata, analysis results, and strategy definitions
...
PROMPT ========================================
PROMPT User Creation Complete (Central DB)
PROMPT ========================================
